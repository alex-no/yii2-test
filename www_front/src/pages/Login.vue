<template>
  <form @submit.prevent="handleLogin" class="max-w-md mx-auto bg-white p-6 mt-3 rounded-xl shadow-md">
    ...
    <div class="mb-4">
      ...
      <input v-model="username" type="text" class="border border-gray-300 p-2 rounded-md" required />
    </div>
    ...
    <div class="mb-4">
      ...
      <input v-model="password" type="password" class="border border-gray-300 p-2 rounded-md" required />
    </div>
